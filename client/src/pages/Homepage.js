    ...
    <>
      <div className="container-fluid bg-dark">
       ...
       <div className="container d-flex text-white my-3">
         ...
         <Link to="/thought" ><button className="bg-success">Add Reviews</button></Link>
          </div>
      ...
      <div className="container text-center mt-4">
        <h1>What We Do</h1>
          ...
          <h2>Tattooing</h2>
          <p> If you want a true piece of artwork displayed on your body - run, don't walk, to Jade Tattoo HotSpot! A custom design will have to book several months in advance. It is easy to book the initial consult where we will listen carefully to your design ideas and ask you to provide reference materials.</p>
            </div>
            <div className="col text-center">
            <img src={icon2} alt="Freepik" width="80px"/>
            <h2>Piercing</h2>
          <p> We also offer piercing and you just have to provide your materials needed. The cost of a body piercing varies depending on the location of the body being pierced, the type of piercing and the individual piercer.</p>
            </div>
            <div className="col text-center">
            <img src={icon4} alt="Freepik" width="80px"/>
            <h2>Tattoo Design </h2>
