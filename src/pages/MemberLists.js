    ...
    members.map((member) => (
      ...
      >
        <div>
          ...
          <span className="font-normal text-white-600">{member.phone}</span>
          <span className="font-normal text-white-600">{member.message}</span>
          <span className="font-normal text-white-600">{member.date}</span>
        </div>
        <div>
